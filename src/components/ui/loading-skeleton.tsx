...
// Profile hero banner skeleton
export function ProfileHeroBannerSkeleton() {
  return (
    <div className="rounded-2xl bg-muted/30 p-6 sm:p-8 animate-pulse">
  ...
  return (
    <div className="glass-card p-6 animate-pulse">
      ...
      <div className="max-w-md mx-auto">
        <div className="rounded-xl border border-border/50 p-6 sm:p-8 text-center mb-6">
