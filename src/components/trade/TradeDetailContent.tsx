...
const CARD = 'bg-card/50 border border-border/50 rounded-xl p-3.5 overflow-hidden';
const EMPTY_CARD = 'bg-card/20 border border-dashed border-border/30 rounded-xl p-3.5 overflow-hidden';
...
export function TradeDetailContent({
  ...
  return (
    <>
      {/* STICKY HEADER */}
      {!hideHeader && (
        <div className="pl-6 pr-12 py-3.5 border-b border-border/50 bg-card/90 backdrop-blur-xl flex items-center justify-between shrink-0">
      ...
      <div className="flex-1 overflow-hidden flex flex-col min-h-0">
        {/* KPI STRIP */}
        <div className="shrink-0 grid grid-cols-6 px-6 py-3 border-b border-border/30">
        ...
        {/* BENTO GRID */}
        <div className="p-4 px-6 flex-1 min-h-0 grid grid-cols-[2fr_1fr] grid-rows-[minmax(0,3fr)_minmax(0,2fr)_minmax(0,1fr)] gap-3">

          {/* SCREENSHOT HERO (spans 2 rows) */}
          <div className="row-span-2 flex flex-col gap-2.5 min-h-0 overflow-hidden">
            {hasImages && heroImage ? (
              <>
                <div
                  className="group relative flex-1 min-h-0 rounded-xl overflow-hidden border border-border/50 bg-gradient-to-br from-[hsl(220_18%_12%)] to-[hsl(220_18%_8%)] cursor-pointer hover:border-primary/40 hover:shadow-[0_0_20px_hsl(160_84%_39%/0.1)] transition-all"
              ...
              <div className="flex-1 min-h-[200px] rounded-xl border border-dashed border-border/50 bg-gradient-to-br from-[hsl(220_18%_12%)] to-[hsl(220_18%_8%)] flex flex-col items-center justify-center gap-3">
                <div className={cn(
